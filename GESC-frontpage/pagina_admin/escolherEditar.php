            ...
            <tbody>
                ...
                while ($dadosEvento = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                                  ...
                                  <a class='btn btn-sm btn-danger' data-bs-toggle='modal' data-bs-target='#staticBackdrop'  href='deletar.php?idEvento=$dadosEvento[idEvento]'>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <button type='submit' class='btn btn btn-danger'><a href='deletar.php?idEvento=$dadosEvento[idEvento]'>Excluir Evento</a></button>
            </div>";
